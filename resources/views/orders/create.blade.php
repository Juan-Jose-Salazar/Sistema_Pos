...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="mb-1">Crear pedido</h2>
            <p class="text-muted mb-0">Define el cliente, asigna el mesero y agrega los productos del pedido.</p>
        </div>
    ...
    <form action="{{ route('orders.store') }}" method="POST" class="card shadow-sm p-4">
        @csrf
